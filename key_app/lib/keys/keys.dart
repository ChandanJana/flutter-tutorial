...
//import 'package:key_app/keys/todo_item.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  /// ValueKey wants a value, any kind of value.
                  /// It's a dynamic type.
                  /// So you can pass a number,
                  /// a text or anything like this.
                  /// And this will then internally be used
                  /// as an identification criteria.
                  /// passed value must be unique
                  key: ValueKey(todo.text),
                  /// ObjectKey we can use for ey identification
                  //key: ObjectKey(todo),
                  todo.text,
                  todo.priority,
                ),
